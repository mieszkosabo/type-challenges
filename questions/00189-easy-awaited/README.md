...
# SOLUTION
```ts
type MyAwaited<T extends PromiseLike<any>> = T extends PromiseLike<infer U> ? UnwrapWhilePromise<U> : never;
type UnwrapWhilePromise<T> = T extends PromiseLike<infer U> ? UnwrapWhilePromise<U> : T;
```
